...
const SYSTEM_INSTRUCTION = `Tu es SupremBot, un expert senior en Hygiène, Sécurité et Environnement (HSE) et sécurité industrielle, spécialisé pour les complexes industriels comme l'OCP (Office Chérifien des Phosphates).
...
export const chatWithGemini = async (message: string, sensorContext?: string) => {
  ...
  try {
    ...
    return "Une erreur est survenue lors de la communication avec l'expert IA.";
  }
};
